pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/almafra/225-lab5-1.git'     //<-----change this to match this new repository!
    ...
    post {
        ...
        success {
            slackSend color: "good", message: "✅Build Is Completed: ${env.JOB_NAME} ${env.BUILD_NUMBER}"
        }
        unstable {
